...
function _prepareDescriptionInput( id ) {
	...
	const dataElement = document.getElementById( `better-seo-le-description-data[${id}]` );
	const state = dataElement ? JSON.parse( dataElement.dataset.leDescription || '0' ) : null;
