<?php
/**
 * Better SEO - View: List Quick Term Edit
 *
 * @package    Better_SEO
...
<div class="better-seo-quick-edit-columns">
	...
	/**
	 * Fires before the Better SEO quick edit fields are output for terms.
	 *
	 * @since 1.0.0
	...
	<?php
	/**
	 * Fires after the Better SEO quick edit fields are output for terms.
	 *
	 * @since 1.0.0
	 * @param string $post_type The current post type slug.
	 * @param string $taxonomy  The current taxonomy slug.
